...
<div id="k2Container" class="itemListView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<div class="itemListCategoriesBlock clearfix">
		...
		<div class="itemListSubCategories">
			<h2><?php echo JText::_('Children categories'); ?></h2>
			...
			<?php if ($k2count) : ?>
				...
				<?php $k2count = 0; ?>
			<?php endif; ?>
			<div class="article_column" style="width:<?php echo number_format(100/$this->params->get('subCatColumns'), 1); ?>%;">
	...
	<div class="itemList">
		...
		<div id="itemListLeading">
			...
			<?php if ($k2count) : ?>
				...
				<?php $k2count = 0; ?>
			<?php endif; ?>
			<div class="article_column" style="width:<?php echo number_format(100/$this->params->get('num_leading_columns'), 1); ?>%;">
			<?php
		...
		<div id="itemListPrimary">
			...
			<?php if ($k2count) : ?>
				...
				<?php $k2count = 0; ?>
			<?php endif; ?>
			<div class="article_column" style="width:<?php echo number_format(100/$this->params->get('num_primary_columns'), 1); ?>%;">
			<?php
				// Load category_item.php by default
				$this->item=$item;
				echo $this->loadTemplate('item');
		...
		<div id="itemsListSecondary">
			...
			<?php if ($k2count) : ?>
				...
				<?php $k2count = 0; ?>
			<?php endif; ?>
			<div class="article_column" style="width:<?php echo number_format(100/$this->params->get('num_secondary_columns'), 1); ?>%;">
			<?php
				// Load category_item.php by default
				$this->item=$item;
				echo $this->loadTemplate('item');
		...
		<!-- Link items -->
		<div class="blog_more">
			<h2><?php echo JText::_('More...'); ?></h2>
			<ul class="blogsection">
			<?php foreach($this->links as $key=>$item): ?>
			<li style="width:<?php echo number_format(100/$this->params->get('num_links_columns'), 1); ?>%;">
			<?php
	...
	<?php if($this->params->get('catPaginationResults')) echo "<p class=\"counter\"><span>".$this->pagination->getPagesCounter()."</span></p>"; ?>
