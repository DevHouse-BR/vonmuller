...
<div id="k2Container" class="itemView<?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
			...
			<div class="buttonheading">
				...
				<span>
					<a href="#" id="fontDecrease">
						<img alt="<?php echo JText::_('decrease font size'); ?>" title="<?php echo JText::_('decrease font size'); ?>" src="templates/ja_norite/images/user-decrease.png">
					</a>
				</span>
				<span>
					<a href="#" id="fontIncrease">
						<img alt="<?php echo JText::_('increase font size'); ?>" title="<?php echo JText::_('increase font size'); ?>" src="templates/ja_norite/images/user-increase.png">
					</a>
				</span>
				<?php endif; ?>
				...
				<span>
					...
					<a class="itemPrintLink" href="<?php echo $this->item->printLink; ?>" onclick="window.print();return false;">
						<img alt="<?php echo JText::_('Print'); ?>" title="<?php echo JText::_('Print'); ?>" src="templates/ja_norite/images/printButton.png">
					</a>		
					<?php else: ?>
				...
				<span>
					<a class="itemEmailLink" onclick="window.open(this.href,'win2','width=400,height=350,menubar=yes,resizable=yes'); return false;" href="<?php echo $this->item->emailLink; ?>">
						<img alt="<?php echo JText::_('E-mail'); ?>" title="<?php echo JText::_('E-mail'); ?>" src="templates/ja_norite/images/emailButton.png">
					</a>
				</span>
				<?php endif; ?>
			</div>
  ...
  <?php if(
  ($this->item->params->get('itemDateModified') && intval($this->item->modified)!=0) ||
  ...
  <div class="ItemLinks">
		...
		<div class="itemHitsTwitter clearfix">
  ...
  <!-- Latest items from author -->
	<div class="itemAuthorLatest">
		<h4><?php echo JText::_("Latest from"); ?> <?php echo $this->item->author->name; ?></h4>
  ...
  <!-- Related items by tag -->
	<div class="itemRelated">
		<h4><?php echo JText::_("Related items (by tag)"); ?></h4>
		<ul class="blogsection">
 ...
 <?php if(
  ...
  <?php endif; ?>
	...
	<ul class="ja-links">
		<li class="top"><a href="<?php echo $this->item->link; ?>#startOfPageId<?php echo JRequest::getInt('id'); ?>" title="<?php echo JText::_("back to top"); ?>" ><?php echo JText::_("Top"); ?></a></li>
	</ul>
</div>
<!-- End K2 Item Layout -->
