...
<div class="listLatestItem">
	...
	<?php if ($k2count) : ?>
		...
		<?php $k2count = 0; ?>
	<?php endif; ?>
	<div class="article_column" style="width:<?php echo number_format(100/$this->params->get('latestItemsCols'), 1); ?>%;">
		...
		<div class="latestItemsCategory">
			...
			<h2 class="componentheading clearfix"><a href="<?php echo $category->link; ?>"><?php echo $category->name; ?></a></h2>
			<?php endif; ?>
