...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlock <?php echo $params->get('moduleclass_sfx'); ?>">
  ...
  <ul class="ja-itemlist">
    ...
    <li class="<?php echo ($key%2) ? "odd" : "even"; ?>">
      ...
      <a class="ja-title" href="<?php echo $item->link; ?>"><?php echo $item->title; ?></a>
      <?php endif; ?>
	  
      <?php if($params->get('itemAuthor')): ?>
		<span class="ja-createby">
		<?php if(isset($item->authorLink)): ?>
			<a class="moduleItemAuthorLink" href="<?php echo $item->authorLink; ?>" title="<?php echo K2HelperUtilities::writtenBy($item->authorGender); ?> <?php echo $item->author; ?>"><?php echo $item->author; ?></a>
		<?php else: ?>
      ...
      <span class="ja-createdate"> - <?php echo JHTML::_('date', $item->created, JText::_('DATE_FORMAT_LC3')); ?></span>
      <?php endif; ?>
      
      <?php if($params->get('itemCategory')): ?>
      <span class="ja-category"> - <a href="<?php echo $item->categoryLink; ?>"><?php echo $item->categoryname; ?></a></span>
      <?php endif; ?>
