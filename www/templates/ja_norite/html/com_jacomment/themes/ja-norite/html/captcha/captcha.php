<?php
	...
	$captcha->arcline_colors = "#333333,#cc0000,#000fff,#fffccc";
	$captcha->text_color = "#CC0000";
	...
	$captcha->multi_text_color = "#333333,#FDA40A,#8BBE31";
	$captcha->image_bg_color = "#000000";
	$captcha->xpos_start = 10;
	$captcha->font_size = 30;
	$captcha->text_entered;
	$captcha->text_angle_minimum = - 20;
	$captcha->text_angle_maximum = 20;
	$captcha->text_minimum_space = 25;
	...
	$captcha->imgwidth = 160;
	$captcha->imgheight = 50;