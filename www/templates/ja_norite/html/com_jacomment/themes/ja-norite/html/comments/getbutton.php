...
?>	
	...
	<?php if($display_comment_link) { ?>			
		<a class="jac-links" style="background: url('components/com_jacomment/asset/images/comment.png') no-repeat left center; padding-left: 16px;" href="<?php echo $links; ?>" title="<?php echo JText::_('Comment '); ?>">
	<?php }?>
		
	<?php if($display_comment_count) { ?>	
	<span class="jac-count-comment">
	<?php
	 echo "(".$totalAll.")"; 
	 if ( $totalAll > 1 ) { echo "<span>". JText::_(' Comments') ."</span>"; } else echo JText::_(' Comment'); ?>
	 </span>
	<?php }?>
...
<?php if($typeDisplay == "onlyButton" && $display_comment_link){?>	
	<div class="jac-add-button"><a class="jac_links" style="background: url('components/com_jacomment/asset/images/comment.png') no-repeat left center; padding-left: 16px;" href=<?php echo $links; ?> title="<?php echo JText::_('Add comment '); ?>"><?php echo JText::_('Add comment '); ?></a>
	<?php if(!$display_comment_count){?>
		</div>
	<?php }?>
<?php		
...
?>
	...
	<?php }?>
	<span class="jac_links">(<?php echo $totalAll;?>)</span></div>
<?php		
	}	
}
?>