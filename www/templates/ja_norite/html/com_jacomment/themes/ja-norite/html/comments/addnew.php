		...
		<li>
			<div id="other_field" class="clearfix">
				<div class="form-userdata clearfix">
					<!-- BEGIN TEXT NAME-->
					<span class="jac-form-guest clearfix">
						...
						<input id="guestName" value="<?php echo JText::_("NAME");?>..." name="name" type="text" class="field text inputbox jac-inner-text" size="18" tabindex="2" title="<?php echo JText::_("Displayed next to your comments.");?>"/><span id="required_1" class="required"><?php echo JText::_("TEXT_REQUIRED");?></span>
						<input type="hidden" value="<?php echo JText::_("NAME");?>..." id="jac_hid_text_name">						
					...
					<span class="jac-form-guest clearfix">
						...
						<input type="hidden" value="<?php echo JText::_("EMAIL");?>..." id="jac_hid_text_email">
						<input id="guestEmail" value="<?php echo JText::_("EMAIL");?>..." name="email" type="text" class="field text inputbox jac-inner-text" value="" size="18" tabindex="3" title="<?php echo JText::_("Not displayed publicly.");?>"/><span id="required_2" class="required"><?php echo JText::_("TEXT_REQUIRED");?></span>
					...
					<span class="jac-form-guest clearfix">
						<input type="hidden" value="<?php echo JText::_("WEBSITE");?>" id="jac_hid_text_website">
						<input id="guestWebsite" name="website" type="text" class="field text inputbox jac-inner-text" value="<?php echo JText::_("WEBSITE");?>" size="18" tabindex="4" title="<?php echo JText::_("(Optional) "); echo JText::_("If you have a website, link to it here.");?>" />												
					</span>
					<?php }?>
					<!-- END WEBSITE-->
				</div></div>
			...
			<div class="jac-expand-form clearfix">				
				...
				<li class="clearfix">
					...
					<div id="jac-new-captcha">
						<div class="ja-captcha-img">
							<img alt="<?php echo JText::_("Click here to refresh captcha");?>" title="<?php echo JText::_("Click to refresh captcha");?>" onmousemove="actionjacLoadNewCaptcha('show')" onmouseout="actionjacLoadNewCaptcha()" onclick="jacLoadNewCaptcha(0)" id="jac_image_captcha"  src="index.php?option=com_jacomment&amp;task=displaycaptchaaddnew"/>						
						...
						<input type="text" name="captcha" class="field text inputbox jac-inner-text" id="textCaptcha" tabindex="5" value="<?php echo JText::_("TEXT_INPUT_CAPTCHA");?>"/><span id="required_4" class="required"><?php echo JText::_("TEXT_REQUIRED");?></span>
