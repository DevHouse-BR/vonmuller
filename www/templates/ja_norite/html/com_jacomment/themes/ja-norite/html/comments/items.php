		...
		<div id="jac-content-of-comment-<?php echo $item->id?>" class="comment-contentmain comment-contentholder clearfix ja-imagesize<?php echo $avatarSize;?> <?php if($item->isSpecialUser){ echo " comment-byadmin";}else{if($item->isCurrentUser) echo " comment-byyou";}if($item->type == 0) echo " comment-ispending"; ?>">												
	        ...
	        <div class="avatar clearfix">                	
          	...
          	<div class="user_post">			
				...
				<div id="jac-div-footer-<?php echo $item->id;?>" class="jac-div-footer">
  				<div class="comment-action clearfix">
  					...
  					<?php }else{ $checkQuocte = 1;?>																																			
  						<a onclick="replyComment(<?php echo $item->id;?>,'<?php echo JText::_("Posting");?>','<?php echo JText::_("Reply");?>')" href="#jacommentid:<?php echo $item->id;?>" id="jac-a-reply-<?php echo $item->id;?>" title="<?php echo JText::_("Reply comment");?>"><span id="reply-<?php echo $item->id;?>"><?php echo JText::_("Reply");?></span></a>																						
  					<?php }?>
  					<?php }?>
  					</div>					
	          ...
	          <div class="comment-ranking" id="jac-vote-comment-<?php echo $item->id; ?>">	          	
	          	<span class="vote-comment-<?php echo $avatarSize;?> comment-rankingresult" id="voted-of-<?php echo $item->id;?>"><?php echo $item->totalVote;?></span>
