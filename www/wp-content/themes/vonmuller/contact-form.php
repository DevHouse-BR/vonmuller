...
<!-- -->
            ...
            <div class="header"><?php echo __('Feedback', LANGUAGE_ZONE); ?></div>
            ...
            <div class="i_h"><div class="l"><input type="text" name="f_name" placeholder="<?php echo __('Your name', LANGUAGE_ZONE); ?>" id="name" class="validate[required]" title="<?php echo __('Your name', LANGUAGE_ZONE); ?>"></div></div> 
            <div class="i_h"><div class="r"><input type="text" name="f_email" placeholder="<?php echo __('E-mail', LANGUAGE_ZONE); ?>" id="f_email2" class="validate[required,custom[email]]" title="<?php echo __('E-mail', LANGUAGE_ZONE); ?>"></div></div>
            <div class="t_h"><textarea placeholder="<?php echo __('Message', LANGUAGE_ZONE); ?>" cols="40" rows="8"  name="f_comment" id="comment" class="validate[required]"></textarea></div>
