...
function dt_gallery_custom($attrs) {
   ...
   $pic = get_template_directory_uri().'/thumb.php?src='.$pic.'&amp;w='.$w.'&amp;h='.$h.'&amp;zc=1';
...
<div class="big_gallery">
  ...
  <div class="multipics">
      ';
       ...
       $small_image = esc_attr(get_template_directory_uri().'/thumb.php?src='.$orig_image.'&w='.$w.'&h='.$h.'&zc=1');
       $big_image = $orig_src;//get_template_directory_uri().'/thumb.php?src='.$orig_image.'&amp;w=800&amp;h=&amp;zc=1&amp;nores=1';
