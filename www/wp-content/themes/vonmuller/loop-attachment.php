    ...
    <div class="article_box">
      ...
      <div class="article">
        ...
        <?php 
          ...
          $large_image_url = get_template_directory_uri().'/thumb.php?src='.$large[0].'&amp;w=800&amp;h=&amp;zc=1';
          ...
          $thumb = get_template_directory_uri().'/thumb.php?src='.$large[0].'&amp;w='.$w.'&amp;h='.$h.'&amp;zc=1';       
...
?>
	<p class="attachment"><a href="<?php echo $next_attachment_url; ?>" title="<?php echo esc_attr( get_the_title() ); ?>" rel="attachment"><?php
		...
		{
		   $large[0] = str_replace(site_url(), "", $large[0]);
		   echo '<img src="'.get_template_directory_uri().'/thumb.php?src='.$large[0].'&amp;w=660&amp;h=&amp;zc=1&amp;nores=1" >';
		}
	?></a></p>
