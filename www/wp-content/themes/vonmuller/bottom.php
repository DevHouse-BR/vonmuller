	...
	<?php elseif( !is_page_template('home-video.php') ): ?>
		<div> 
			...
			<?php if( !is_page_template('home-static.php') ): ?>
				<div style="font-size: 10px;position: absolute;bottom: 6px;right: 56px;">Desenvolvido por <a target="_blank" href="http://www.devhouse.com.br"><img style="height: 30px; vertical-align: middle; margin-left: 10px; border: 0;" src="http://www.devhouse.com.br/wp-content/uploads/2012/07/devhouse_logo_pq.png" /></a></div>
