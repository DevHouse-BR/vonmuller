jQuery(document).ready(function($) {
   ...
   $(".upload_multiple").uploadify({
      'uploader'       : '../wp-content/themes/vonmuller/js/upload/uploadify.swf',
      'script'         : "../wp-content/themes/vonmuller/uploadify.php",
      'cancelImg'      : '../wp-content/themes/vonmuller/js/upload/cancel.png',
      //'buttonImg'      : '../wp-content/themes/vonmuller/js/upload/button.png',
      'scriptData'     : sc,
      'method'         : 'GET',
      'fileDataName'   : "file",
      ...
      'onComplete'     : function (event, queueID, fileObj, response, data) {
         ...
         $.ajax({
            //url: "../wp-content/themes/vonmuller/uploadify.php",
            url: ajaxurl,
            type: "POST",
            data: d,
            //dataType: "json",
