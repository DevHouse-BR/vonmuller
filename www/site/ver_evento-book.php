...
function constroi_fotos_evento($codigo_evento, $colunas){
	...
	<a style="font-weight: normal; font-size: 11px;" class="menurodape" href="books.php">[BOOKS FOTOGRÁFICOS]</a>&nbsp;-&nbsp;<a class="menurodape" style="font-weight: normal; font-size: 11px;">[<?=$evento["tipo"]?>&nbsp;<?=$evento["nomes"]?>]</a>
	<hr>
