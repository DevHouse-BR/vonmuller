...
function loadText()
    ...
    txtLang[6].innerHTML = "\u6587\u5b57\u88dd\u98fe ";
    txtLang[7].innerHTML = "\u5927\u5c0f\u5beb ";
    txtLang[8].innerHTML = "\u8ff7\u4f60\u5c0f\u5beb ";
    txtLang[9].innerHTML = "\u5782\u76f4 ";

    txtLang[10].innerHTML = "\u6c92\u6709\u8a2d\u5b9a ";
    txtLang[11].innerHTML = "\u5e95\u7dda ";
    txtLang[12].innerHTML = "\u4e0a\u52a0\u7dda ";
    txtLang[13].innerHTML = "\u522a\u9664\u7dda ";
    txtLang[14].innerHTML = "\u6c92\u6709 ";

    txtLang[15].innerHTML = "\u6c92\u6709\u8a2d\u5b9a ";
    txtLang[16].innerHTML = "\u6a19\u984c\u5927\u5beb ";
    txtLang[17].innerHTML = "\u5168\u90e8\u5927\u5beb ";
    txtLang[18].innerHTML = "\u5168\u90e8\u5c0f\u5beb ";
    txtLang[19].innerHTML = "\u6c92\u6709 ";

    txtLang[20].innerHTML = "\u6c92\u6709\u8a2d\u5b9a ";
    txtLang[21].innerHTML = "\u5927\u5beb ";
    txtLang[22].innerHTML = "\u666e\u901a ";

    txtLang[23].innerHTML = "\u6c92\u6709\u8a2d\u5b9a ";
    txtLang[24].innerHTML = "\u4e0a\u6a19 ";
    txtLang[25].innerHTML = "\u4e0b\u6a19 ";
    txtLang[26].innerHTML = "\u76f8\u5c0d ";
    txtLang[27].innerHTML = "\u57fa\u6e96\u7dda ";
    
    txtLang[28].innerHTML = "\u5b57\u5143\u9593\u8ddd ";
    txtLang[29].innerHTML = "\u9810\u89bd ";
    txtLang[30].innerHTML = "\u61c9\u7528\u81f3 ";
